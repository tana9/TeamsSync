...
internal sealed class GraphUserSearchService(GraphSdkClient sdk)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        string searchText = identifier.Replace("\\", "\\\\").Replace("\"", "\\\"");
        string search = $"\"displayName:{searchText}\"";
        List<DirectoryUser> nameMatches = GraphResponseParser
        ...
        string normalized = UserIdentifier.NormalizeName(identifier);
